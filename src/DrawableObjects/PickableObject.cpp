...
// Initializing the static objects outside the class
std::vector<PickableObject*> PickableObject::s_GeneratedObjs;
PickableObject* PickableObject::s_SelectedObj = nullptr;
